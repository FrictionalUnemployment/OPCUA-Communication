...
class StandardItem(Qt.QStandardItem):
    def __init__(self, txt='', font_size=10, check_box=False, set_bold=False, color=QtGui.QColor(0, 0, 0)):
        super().__init__()
    ...
    def __init__(self, server, server_name):
        ...
        for key, values in self.NODE_MAP.items():
            for value in values:
                ...
                self.MAP_VALUE_NODES[key].append(StandardItem(value, 8, color=QtGui.QColor(0, 0, 0)))
